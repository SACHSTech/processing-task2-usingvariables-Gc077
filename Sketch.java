...
/**
* This program Sketch.Java calls functions to draw a scene with a house and sun, 
* it can be scaled to any size and the drawings generated will use width and height variables 
* to stay a similar size to the originals
